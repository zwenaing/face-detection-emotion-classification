...
def vgg14():
    ...
    r1_c2 = Conv2D(filters=32, kernel_size=[3, 3], padding="same", activation="relu", bias_initializer=Zeros())(r1_c1)
    r1_p1 = MaxPooling2D(pool_size=(2, 2), strides=2, padding="valid")(r1_c2)

    r2_c1 = Conv2D(filters=64, kernel_size=[3, 3], padding="same", activation="relu", bias_initializer=Zeros())(r1_p1)
    r2_c2 = Conv2D(filters=64, kernel_size=[3, 3], padding="same", activation="relu", bias_initializer=Zeros())(r2_c1)
    r2_p1 = MaxPooling2D(pool_size=(2, 2), strides=2, padding="valid")(r2_c2)

    r3_c1 = Conv2D(filters=128, kernel_size=[3, 3], padding="same", activation="relu", bias_initializer=Zeros())(r2_p1)
    r3_c2 = Conv2D(filters=128, kernel_size=[3, 3], padding="same", activation="relu", bias_initializer=Zeros())(r3_c1)
    r3_c3 = Conv2D(filters=128, kernel_size=[3, 3], padding="same", activation="relu", bias_initializer=Zeros())(r3_c2)
    r3_p1 = MaxPooling2D(pool_size=(2, 2), strides=2, padding="valid")(r3_c3)
    ...
    r4_c3 = Conv2D(filters=256, kernel_size=[3, 3], padding="same", activation="relu", bias_initializer=Zeros())(r4_c2)
    r4_c4 = Conv2D(filters=256, kernel_size=[3, 3], padding="same", activation="relu", bias_initializer=Zeros())(r4_c3)
    r4_p1 = MaxPooling2D(pool_size=(2, 2), strides=2, padding="valid")(r4_c4)
    ...
    model.load_weights("../data/vgg14_raw/" + "keras_vgg14.h5")

    model.save_weights("keras_vgg15.h5")
